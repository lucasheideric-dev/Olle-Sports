            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-3">
                            <?= $this->Form->control('data_publicacao', ['label' => 'Data da Publicação', 'class' => 'form-control datepicker', 'type' => 'text']); ?>
                        </div>
                        ...
                        <div class="col-4">
                            <?= $this->Form->control('caminho_foto_titulo', ['label' => 'Imagem Titulo', 'class' => 'form-control', 'type' => 'file', 'required' => false]); ?>
                        </div>

                        <div class="col-4">
                            <?= $this->Form->control('caminho_foto_conteudo', ['label' => 'Imagem Conteúdo', 'class' => 'form-control', 'type' => 'file', 'required' => false]); ?>
                        </div>

                        <div class="col-lg-12 mt-3">
                            <?= $this->Html->image($artigo->caminho_foto_titulo, ['style' => 'max-width: 200px;']); ?>
                            <?= $this->Html->image($artigo->caminho_foto_conteudo, ['style' => 'max-width: 200px;']); ?>  
                        </div>


                        <div class="text-center">
                            <a href="<?= $this->Url->build(['controller' => 'Artigos', 'action' => 'index']) ?>" class="btn btn-secondary">Voltar</a>
